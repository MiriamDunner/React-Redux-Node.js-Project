...
const options = [
  { label: 'מרחק', explanation: 'משקפי שמש לראיה חדה ממרחק ,ללא קירנה המזיקה לעניים' },
  { label: 'ללא מספר', explanation: 'רוצים הגנה מקרינת שמש?  הלבישו משקפי הגנה מכל קרינה מזיקה!!' },
];

function SunglassesOptions({ product }) {
  ...
  const isNoPrescription = selected === 'ללא מספר';
...
export default SunglassesOptions;
